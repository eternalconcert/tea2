...
%token TOKIF TOKELSE TOKFN TOKRETURN TOKWHILE TOKFOR TOKIN TOKBREAK TOKCONTINUE TOKIMPORT TOKEXPORT TOKTHROW TOKNOT
...
for_loop:
    ...
    |
    TOKFOR '(' TOKIDENT TOKIN expressions ')' lbrace statements rbrace {
        ForEachNode *forEachNode = new ForEachNode($3, $5);
        $$ = forEachNode;
        forEachNode->addToChildList($8);
    }
    ;
